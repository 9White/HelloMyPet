# -*- coding: utf-8 -*-
"""伸懒腰视频 123 帧入库：等比例对齐主形象（高 575）、720 画布中心 383 底边 690、
逐帧增益平滑、轻锐化、半透明区填毛色。输出 frames/model_stretch_full_001~123.png。"""
import os

from PIL import Image, ImageChops, ImageFilter

CUT = r"F:\AI产物\doubao\deskpet\assets\video_frames\user_stretch_cut"
...
for i, im in enumerate(imgs, 1):
    ...
    sharp.putalpha(a)
    sharp.save(os.path.join(FRAMES, f"model_stretch_full_{i:03d}.png"))
    if i % 40 == 0:
        print(i, flush=True)
print("done")
